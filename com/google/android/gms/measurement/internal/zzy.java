...
public abstract class zzy {
    ...
    private static Boolean zzd(String str, int i2, boolean z, String str2, List list, String str3, zzeh zzehVar) {
        if (i2 == 7) {
    ...
    public static Boolean zzh(long j2, com.google.android.gms.internal.measurement.zzer zzerVar) {
        try {
            return zze(new BigDecimal(j2), zzerVar, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
