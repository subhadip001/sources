...
public final class zzag extends zzgk {
    ...
    public final int zzf(String str, zzdt zzdtVar, int i2, int i3) {
        return Math.max(Math.min(zze(str, zzdtVar), i3), i2);
    }
    ...
    public final Boolean zzk(String str) {
        ...
        Bundle zzj = zzj();
        if (zzj == null) {
            a.J(this.zzt, "Failed to load metadata: Metadata bundle is null");
            return null;
