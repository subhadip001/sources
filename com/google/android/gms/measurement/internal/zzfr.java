...
public final class zzfr implements zzgm {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (zzq.zzt.zze.getApplicationContext() instanceof Application) {
                ...
                if (z) {
                    ...
                    a.K(zzq.zzt, "Registered activity lifecycle callback");
                }
            }
        } else {
            a.L(this, "Application context is not an Application");
        }
    ...
    public final void zzE() {
        ...
        if (this.zzk.zzr() && !((Boolean) zzb.second).booleanValue() && !TextUtils.isEmpty((CharSequence) zzb.first)) {
            ...
            a.L(this, "Network is not available for Deferred Deep Link request. Skipping");
            return;
        }
        ...
        if (!zzM()) {
            if (zzJ()) {
                if (!zzv().zzad("android.permission.INTERNET")) {
                    a.J(this, "App is missing INTERNET permission");
                }
                if (!zzv().zzad("android.permission.ACCESS_NETWORK_STATE")) {
                    a.J(this, "App is missing ACCESS_NETWORK_STATE permission");
                }
                if (!Wrappers.packageManager(this.zze).isCallerInstantApp() && !this.zzk.zzx()) {
                    if (!zzlb.zzaj(this.zze)) {
                        a.J(this, "AppMeasurementReceiver not registered/enabled");
                    }
                    if (!zzlb.zzak(this.zze, false)) {
                        a.J(this, "AppMeasurementService not registered/enabled");
                    }
                }
                a.J(this, "Uploading is not possible. App measurement disabled");
            }
        } else {
