...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount zab(String str) {
        ...
        GoogleSignInAccount zaa2 = zaa(jSONObject.optString(Chapter.KEY_ID), jSONObject.has("tokenId") ? jSONObject.optString("tokenId") : null, jSONObject.has("email") ? jSONObject.optString("email") : null, jSONObject.has("displayName") ? jSONObject.optString("displayName") : null, jSONObject.has("givenName") ? jSONObject.optString("givenName") : null, jSONObject.has("familyName") ? jSONObject.optString("familyName") : null, parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet);
    ...
    public int hashCode() {
        return getRequestedScopes().hashCode() + a.I(this.zak, 527, 31);
    }
    ...
    public final String zad() {
        ...
        try {
            if (getId() != null) {
                jSONObject.put(Chapter.KEY_ID, getId());
            }
            if (getIdToken() != null) {
