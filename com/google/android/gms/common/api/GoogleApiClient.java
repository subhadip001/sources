...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api != null) {
                        ...
                        String zad3 = api.zad();
                        throw new IllegalStateException(f.a.b.a.a.v(new StringBuilder(String.valueOf(zad2).length() + 21 + String.valueOf(zad3).length()), zad2, " cannot be used with ", zad3));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (!z) {
                    ...
                    String zad4 = api.zad();
                    throw new IllegalStateException(f.a.b.a.a.v(new StringBuilder(String.valueOf(zad4).length() + 82), "With using ", zad4, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
        ...
        public Builder enableAutoManage(n nVar, int i2, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) nVar);
        ...
        public Builder enableAutoManage(n nVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(nVar, 0, onConnectionFailedListener);
            return this;
        }
