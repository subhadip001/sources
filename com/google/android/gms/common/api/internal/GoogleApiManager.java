...
public class GoogleApiManager implements Handler.Callback {
    ...
    private long zae = FirebaseInAppMessagingDisplay.IMPRESSION_THRESHOLD_MILLIS;
    ...
    public static Status zaH(ApiKey<?> apiKey, ConnectionResult connectionResult) {
        ...
        return new Status(connectionResult, a.w(new StringBuilder(String.valueOf(zab2).length() + 63 + valueOf.length()), "API: ", zab2, " is not available on this device. Connection failed with: ", valueOf));
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i2) {
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabq.zai(zabqVar, new Status(17, a.w(new StringBuilder(String.valueOf(errorString).length() + 69 + String.valueOf(errorMessage).length()), "Error resolution was canceled by the user, original error message: ", errorString, ": ", errorMessage)));
                        break;
                    } else {
            ...
            case 19:
                ...
                break;
            default:
                a.G(31, "Unknown message id: ", i2, "GoogleApiManager");
                return false;
        }
        return true;
    }
