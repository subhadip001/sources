...
public final class zabq<O extends Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaL(zai zaiVar) {
        ...
        f.a.b.a.a.R(sb, name, " could not execute call because it requires feature (", name2, ", ");
        sb.append(version);
        sb.append(").");
    ...
    public final void zas(ConnectionResult connectionResult) {
        ...
        client.disconnect(f.a.b.a.a.w(new StringBuilder(name.length() + 25 + valueOf.length()), "onSignInFailed for ", name, " with ", valueOf));
        zar(connectionResult, null);
    }
