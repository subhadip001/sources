...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i2) {
        if (parcel.dataPosition() != i2) {
            throw new ParseException(a.i("Overread allowed size end=", i2), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (getFieldId(readHeader) == 20293) {
            ...
            if (i2 < dataPosition || i2 > parcel.dataSize()) {
                throw new ParseException(a.k("Size read is invalid start=", dataPosition, " end=", i2), parcel);
            }
            return i2;
        }
    ...
    private static void zza(Parcel parcel, int i2, int i3, int i4) {
        ...
        throw new ParseException(a.u(a.C("Expected size ", i4, " got ", i3, " (0x"), Integer.toHexString(i3), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i2, int i3) {
        ...
        throw new ParseException(a.u(a.C("Expected size ", i3, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
