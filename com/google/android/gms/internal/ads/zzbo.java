...
public final class zzbo {
    ...
    public static int zzb(String str) {
        ...
        if (NotificationCompat.MessagingStyle.Message.KEY_TEXT.equals(zzi(str)) || "application/cea-608".equals(str) || "application/cea-708".equals(str) || "application/x-mp4-cea-608".equals(str) || "application/x-subrip".equals(str) || "application/ttml+xml".equals(str) || "application/x-quicktime-tx3g".equals(str) || "application/x-mp4-vtt".equals(str) || "application/x-rawcc".equals(str) || "application/vobsub".equals(str) || "application/pgs".equals(str) || "application/dvbsubs".equals(str)) {
            return 3;
        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            String str2 = ((zzbm) zza.get(i2)).zza;
            if (str.equals(null)) {
                return 0;
            }
        }
