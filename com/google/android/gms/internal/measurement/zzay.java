...
public final class zzay extends zzaw {
    ...
    private static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        return (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || (doubleValue == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && doubleValue2 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) || ((i2 == 0 && doubleValue2 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) || Double.compare(doubleValue, doubleValue2) >= 0)) ? false : true;
    }
