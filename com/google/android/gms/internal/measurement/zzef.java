...
public final class zzef {
    ...
    public final void zzC(com.google.android.gms.measurement.internal.zzgs zzgsVar) {
        ...
        synchronized (this.zzf) {
            for (int i2 = 0; i2 < this.zzf.size(); i2++) {
                if (zzgsVar.equals(((Pair) this.zzf.get(i2)).first)) {
        ...
        synchronized (this.zzf) {
            ...
            while (true) {
                if (i2 >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzgsVar.equals(((Pair) this.zzf.get(i2)).first)) {
    ...
    public final Bundle zzc(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzbzVar.zzb(FirebaseInAppMessagingDisplay.IMPRESSION_THRESHOLD_MILLIS);
        }
        return null;
    }
    ...
    public final List zzq(String str, String str2) {
        ...
        List list = (List) zzbz.zzf(zzbzVar.zzb(FirebaseInAppMessagingDisplay.IMPRESSION_THRESHOLD_MILLIS), List.class);
    ...
    public final Map zzr(String str, String str2, boolean z) {
        ...
        Bundle zzb = zzbzVar.zzb(FirebaseInAppMessagingDisplay.IMPRESSION_THRESHOLD_MILLIS);
