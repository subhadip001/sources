...
public final class zzmy {
    ...
    public static void zzD(Object obj, long j2, byte b) {
        long j3 = (-4) & j2;
        zzmx zzmxVar = zzf;
        int zzj = zzmxVar.zzj(obj, j3);
        int i2 = ((~((int) j2)) & 3) << 3;
        zzmxVar.zzn(obj, j3, ((255 & b) << i2) | (zzj & (~(255 << i2))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void zzE(Object obj, long j2, byte b) {
        long j3 = (-4) & j2;
        zzmx zzmxVar = zzf;
        int i2 = (((int) j2) & 3) << 3;
        zzmxVar.zzn(obj, j3, ((255 & b) << i2) | (zzmxVar.zzj(obj, j3) & (~(255 << i2))));
    }
    ...
    public static void zzn(byte[] bArr, long j2, byte b) {
        zzf.zzd(bArr, zza + j2, b);
    }
