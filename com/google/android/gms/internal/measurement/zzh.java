...
public final class zzh {
    public static double zza(double d2) {
        ...
        if (Double.isInfinite(d2) || d2 == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE || i2 == 0) {
            return d2;
        }
        return Math.floor(Math.abs(d2)) * (i2 > 0 ? 1 : -1);
    }
    ...
    public static int zzb(double d2) {
        ...
        return (int) ((Math.floor(Math.abs(d2)) * (i2 > 0 ? 1 : -1)) % 4.294967296E9d);
    }
