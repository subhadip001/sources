                                        ...
                                        if (zzrVar != null) {
                                            ...
                                            if (zznVar3 != null && zznVar3.zza != null) {
                                                ...
                                                if (valueOf.booleanValue()) {
                                                    ...
                                                    zze2 = zzrVar.zzf(ObjectWrapper.wrap(applicationContext), str, i5, ObjectWrapper.wrap(cursor2));
                                                } else {
                                                    Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                                    zze2 = zzrVar.zze(ObjectWrapper.wrap(applicationContext), str, i5, ObjectWrapper.wrap(cursor2));
                                                }
