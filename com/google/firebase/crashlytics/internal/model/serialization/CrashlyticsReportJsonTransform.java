...
public class CrashlyticsReportJsonTransform {
    ...
    public static /* synthetic */ CrashlyticsReport.Session.Event a(JsonReader jsonReader) {
    ...
    public static /* synthetic */ CrashlyticsReport.FilesPayload.File d(JsonReader jsonReader) {
    ...
    public static /* synthetic */ CrashlyticsReport.CustomAttribute f(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    builder.setInternalKeys(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.f
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                            return CrashlyticsReportJsonTransform.f(jsonReader2);
                        }
                    }));
                    break;
                case 3:
                    builder.setCustomAttributes(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.f
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                            return CrashlyticsReportJsonTransform.f(jsonReader2);
                        }
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case 3373707:
                    ...
                    break;
                case 3530753:
                    if (nextName.equals(MediaInformation.KEY_SIZE)) {
                        c = 1;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    ...
                    break;
                case 1:
                    builder.setThreads(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.c
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                            return CrashlyticsReportJsonTransform.c(jsonReader2);
                        }
                    }));
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    builder.setBinaries(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.e
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(parseArray(jsonReader, b.a));
                    break;
                case 1:
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("files")) {
                builder.setFiles(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.d
                    @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                    public final Object parse(JsonReader jsonReader2) {
                        return CrashlyticsReportJsonTransform.d(jsonReader2);
                    }
                }));
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1335157162:
                    ...
                    break;
                case -1291329255:
                    if (nextName.equals(AnalyticsConstants.BUNDLE_EVENT_NAME_KEY)) {
                        c = 4;
                        break;
                    }
                    break;
            ...
            switch (c) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    builder.setEvents(parseArray(jsonReader, new ObjectParser() { // from class: f.h.e.i.e.e.a.a
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
