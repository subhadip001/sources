...
public class CommonUtils {
    ...
    public static long convertMemInfoToBytes(String str, String str2, int i2) {
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            j3 = convertMemInfoToBytes(upperCase, "MB", BYTES_IN_A_MEGABYTE);
                        } else if (upperCase.endsWith("GB")) {
                            j3 = convertMemInfoToBytes(upperCase, "GB", BYTES_IN_A_GIGABYTE);
                        } else {
