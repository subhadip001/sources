...
public final class CrashlyticsNativeComponentDeferredProxy implements CrashlyticsNativeComponent {
    ...
    public CrashlyticsNativeComponentDeferredProxy(Deferred<CrashlyticsNativeComponent> deferred) {
        ...
        deferred.whenAvailable(new Deferred.DeferredHandler() { // from class: f.h.e.i.e.a
    ...
    public void prepareNativeSession(final String str, final String str2, final long j2, final StaticSessionData staticSessionData) {
        ...
        this.deferredNativeComponent.whenAvailable(new Deferred.DeferredHandler() { // from class: f.h.e.i.e.b
            @Override // com.google.firebase.inject.Deferred.DeferredHandler
            public final void handle(Provider provider) {
                String str3 = str;
                String str4 = str2;
                ...
                int i2 = CrashlyticsNativeComponentDeferredProxy.a;
                ((CrashlyticsNativeComponent) provider.get()).prepareNativeSession(str3, str4, j3, staticSessionData2);
            }
        });
    }
}
