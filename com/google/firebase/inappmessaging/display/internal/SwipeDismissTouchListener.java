...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    private void animateTo(float f2, float f3, AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.firebase.inappmessaging.display.internal.SwipeDismissTouchListener.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                float animatedFraction = (valueAnimator.getAnimatedFraction() * f4) + translationX;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            ...
            if (Math.abs(rawX2) > this.mViewWidth / 2 && this.mSwiping) {
                z = rawX2 > 0.0f;
            } else if (this.mMinFlingVelocity > abs || abs > this.mMaxFlingVelocity || abs2 >= abs || i2 >= 0 || !this.mSwiping) {
                z = false;
                r4 = false;
            } else {
