...
public final class ProxyNotificationInitializer {
    ...
    public static void initialize(Context context) {
        ...
        setEnableProxyNotification(w.f6188f, context, shouldEnableProxyNotification(context));
    }
    ...
    public static boolean isProxyNotificationEnabled(Context context) {
        if (!PlatformVersion.isAtLeastQ()) {
            ...
            StringBuilder A = a.A("error retrieving notification delegate for package ");
            A.append(context.getPackageName());
            Log.e("FirebaseMessaging", A.toString());
            return false;
    ...
    public static Task<Void> setEnableProxyNotification(Executor executor, final Context context, final boolean z) {
        ...
        executor.execute(new Runnable() { // from class: f.h.e.p.x
