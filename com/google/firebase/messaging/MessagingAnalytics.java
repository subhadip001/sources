...
public class MessagingAnalytics {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, f fVar) {
        ...
        try {
            ((n) fVar.b(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, new b("proto"), new d() { // from class: f.h.e.p.a
                @Override // f.h.b.a.d
                public final Object apply(Object obj) {
                    return ((MessagingClientEventExtension) obj).toByteArray();
                }
            })).a(new a(null, MessagingClientEventExtension.newBuilder().setMessagingClientEvent(eventToProto).build(), Priority.DEFAULT), f.h.b.a.i.a.a);
