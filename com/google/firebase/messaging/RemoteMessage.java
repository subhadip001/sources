...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            throw new IllegalArgumentException(f.a.b.a.a.p("Invalid to: ", str));
        }
        ...
        public int getTtl() {
            return Integer.parseInt(this.bundle.getString(Constants.MessagePayloadKeys.MESSAGE_TYPE, CrashlyticsReportDataCapture.SIGNAL_DEFAULT));
        }
