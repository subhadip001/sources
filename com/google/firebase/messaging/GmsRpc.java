...
public class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(w.f6188f, new Continuation() { // from class: f.h.e.p.u
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return GmsRpc.this.a(task2);
            }
        });
    }
    ...
    public Task<?> deleteToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.app), SCOPE_ALL, a.S(EXTRA_DELETE, "1")));
    }
