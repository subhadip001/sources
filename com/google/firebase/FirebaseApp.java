...
public class FirebaseApp {
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: f.h.e.b
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: f.h.e.a
    ...
    public void initializeAllApis() {
        if (!e.i.a.K(this.applicationContext)) {
