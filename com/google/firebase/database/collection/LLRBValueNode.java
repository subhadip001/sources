...
public abstract class LLRBValueNode<K, V> implements LLRBNode<K, V> {
    ...
    public LLRBNode<K, V> insert(K k2, V v, Comparator<K> comparator) {
        ...
        if (compare < 0) {
            copy = copy(null, null, this.left.insert(k2, v, comparator), null);
        } else if (compare == 0) {
            copy = copy(k2, v, null, null);
        } else {
            copy = copy(null, null, null, this.right.insert(k2, v, comparator));
        }
        return copy.fixUp();
    }
    ...
    public LLRBNode<K, V> remove(K k2, Comparator<K> comparator) {
        ...
        if (comparator.compare(k2, this.key) < 0) {
            ...
            if (comparator.compare(k2, rotateRight.key) == 0) {
            ...
            copy = rotateRight.copy(null, null, null, rotateRight.right.remove(k2, comparator));
        }
        return copy.fixUp();
    }
