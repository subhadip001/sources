...
public class DatabaseError {
    ...
    private DatabaseError(int i2, String str) {
        this(i2, str, null);
    }

    public static DatabaseError fromCode(int i2) {
        Map<Integer, String> map = errorReasons;
        if (map.containsKey(Integer.valueOf(i2))) {
            return new DatabaseError(i2, map.get(Integer.valueOf(i2)), null);
        }
        throw new IllegalArgumentException(a.i("Invalid Firebase Database error code: ", i2));
    }
    ...
    public DatabaseException toException() {
        StringBuilder A = a.A("Firebase Database error: ");
        A.append(this.message);
        return new DatabaseException(A.toString());
    }

    public String toString() {
        StringBuilder A = a.A("DatabaseError: ");
        A.append(this.message);
        return A.toString();
    }

    private DatabaseError(int i2, String str, String str2) {
        this.code = i2;
        this.message = str;
