...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: f.h.e.h.k
    ...
    public static final class Builder {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: f.h.e.h.g
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: f.h.e.h.e
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
            ...
            if (component.isValue()) {
                ...
                for (Class<? super Object> cls : component.getProvidedInterfaces()) {
                    if (!this.lazyInstanceMap.containsKey(cls)) {
                        ...
                        arrayList.add(new Runnable() { // from class: f.h.e.h.i
                            @Override // java.lang.Runnable
                            public final void run() {
                                OptionalProvider optionalProvider2 = OptionalProvider.this;
                                Provider provider2 = provider;
                                int i2 = ComponentRuntime.a;
        ...
        for (Map.Entry entry2 : hashMap.entrySet()) {
            if (!this.lazySetMap.containsKey(entry2.getKey())) {
                ...
                for (final Provider provider : (Set) entry2.getValue()) {
                    arrayList.add(new Runnable() { // from class: f.h.e.h.h
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    private static Iterable<Provider<ComponentRegistrar>> toProviders(Iterable<ComponentRegistrar> iterable) {
        ...
        for (final ComponentRegistrar componentRegistrar : iterable) {
            arrayList.add(new Provider() { // from class: f.h.e.h.f
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
