...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final e.f.a<String, Integer> f10g;
    ...
    static {
        e.f.a<String, Integer> aVar = new e.f.a<>();
        f10g = aVar;
    ...
    public MediaMetadataCompat(Parcel parcel) {
        this.f11f = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
